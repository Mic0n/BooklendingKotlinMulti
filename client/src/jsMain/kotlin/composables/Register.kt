    ...
    companion object {
        ...
        fun render(
            ...
            if (user.userId != "0") {
                ...
                if (notification != 0) {
                    NotificationItem.render("Registrierung fehlgeschlagen", "Benutzer existiert bereits", "bg-danger")
                }
                    ...
                    Div(attrs = {
                        ...
                        Div(attrs = {
                            ...
                            Button(attrs = {
                                ...
                                onClick {
                                    scope.launch {
                                        updateUser(apiClient.addUser(UserRequest(name.value, password.value)))
                                        if (user.userId == "0") {
                                            notification += 5
